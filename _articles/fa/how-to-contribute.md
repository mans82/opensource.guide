...
### برای خود مربی پیدا می‌کنید و به دیگران هم آموزش می‌دهید

کار کردن روی یک پروژه‌ی مشترک یعنی همانطور که از دیگران کمک می‌خواهید، باید به دیگران هم کمک کنید و شرح دهید که چگونه کار های خود  را انجام می‌دهید. این یاد دادن و یاد گرفتن می‌تواند برای افرادی که درگیر پروژه هستند،  جذاب باشد.

### روی پروژه های عمومی‌ای کار می‌کنید که برایتان اعتبار (و شغل) می‌سازند

تعریف "متن باز" می‌گوید که همه فعالیت شما در یک پروژه متن باز عمومی است و همه می‌توانند آن را ببینند. که این یعنی شما می‌توانید پروژه هایی که روی آنها فعالیت کرده اید را به عنوان نمونه کار به هر کسی که خواستید نشان دهید.

### مهارت های دیگران را می‌شناسید
